...
<div class="m-4 p-4 mt-10 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-white text-center bg-white bg-opacity-5">
  ...
  <!-- tldr -->
  <p class="text-lg sm:text-base md:text-2xl mt-4"><span class="text-[28px] text-amber-300 mr-2">tldr; </span> Business page for a realtime captioning firm built using Elixir, Phoenix, & LiveView</p>
