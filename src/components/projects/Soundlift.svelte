...
<g>
  ...
  <!-- tldr -->
  <p class="text-lg sm:text-base md:text-3xl mt-4"><span class="text-[28px] text-amber-300 mr-2">tl;dr </span> Main site for an over-the-counter retail company.</p>
  ...
  <div class="flex justify-center rounded-lg border border-solid border-white mx-[15px] text-center bg-white bg-opacity-5">
    <iframe src="https://soundlift.us/" class="flex w-[1350px] h-[390px]" title="SoundLift Hearing Aids"></iframe>
  </div>
</tuner>