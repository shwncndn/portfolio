<script>
  ...
  <div
	class="p-4 my-4 sm:p-6 md:p-8 mt-20 pt-12 sm:pt-14 md:pt-16 flex flex-col gap-4 rounded-lg border border-solid border-white bg-slate-700 bg-opacity-10 text-center group cursor-pointer duration-200"
  ...
  >
	...
	{:else}
	  ...
	  <div class="flex justify-center space-x-4 mt-6 mb-6" transition:slide={{ duration: 300 }}>
		...
		<a href="https://github.com/shwncndn" target="_blank" rel="noopener noreferrer">
		  <svg class="h-20 w-20" enable-background="new 0 0 64 64" height="64px" id="Layer_1" version="1.1" viewBox="0 0 64 64" width="64px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g>
			  ...
			  <g>
				<path d="M25.122,48.166c0.348-0.702,0.773-1.248,1.22-1.643c-3.772-0.432-7.646-1.439-10.381-4.218    C18.065,45.807,21.491,47.4,25.122,48.166z" fill="#114C82"/>
				<path d="M2.614,34.869c0-17.192,13.881-31.125,30.999-31.125c9.505,0,18.007,4.299,23.692,11.061    C51.69,6.845,42.452,1.646,31.999,1.646C14.881,1.646,1,15.579,1,32.771c0,7.665,2.765,14.678,7.344,20.099    C4.743,47.787,2.614,41.581,2.614,34.869z" fill="#6CA9EA"/>
				<path d="M41.339,54.363c0-2.904-0.991-4.805-2.104-5.766c6.906-0.77,14.155-3.402,14.155-15.356    c0-3.398-1.2-6.175-3.19-8.353c0.322-0.787,1.387-3.951-0.307-8.234c0,0-0.322-0.099-0.987-0.061    c0.726,3.23-0.052,5.54-0.319,6.196c1.988,2.178,3.188,4.956,3.188,8.354c0,11.955-7.248,14.585-14.154,15.357    c1.113,0.961,2.104,2.859,2.104,5.764c0,4.162-0.037,7.516-0.037,8.537c0,0.734,0.437,1.571,1.615,1.551    C41.311,60.945,41.339,57.958,41.339,54.363z" fill="#083E66"/>
				<path d="M15.683,54c0.651,1.34,2.839,4.55,8.611,3.874c-0.008-0.706-0.014-1.497-0.018-2.366    C19.823,56.48,17.194,55.334,15.683,54z" fill="#114C82"/>
				<path d="M16.796,49.924c-0.199-0.3-0.572-0.809-1.113-1.318C16.034,49.127,16.407,49.564,16.796,49.924z" fill="#6CA9EA"/>
			  </g>
			</g>
		  </svg>
		</a>
